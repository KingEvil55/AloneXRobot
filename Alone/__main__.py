...
import Alone.modules.no_sql.users_db as sql
from Alone import BOT_USERNAME, CERT_PATH
from Alone import LOGGER as log
from Alone import OWNER_ID, OWNER_USERNAME, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK
from Alone import AloneX as pbot
from Alone import StartTime, dispatcher, telethn, updater

# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from Alone.modules import ALL_MODULES
from Alone.modules.helper_funcs.chat_status import is_user_admin
from Alone.modules.helper_funcs.decorators import Alonecallback, Alonecmd, Alonemsg
from Alone.modules.helper_funcs.misc import paginate_modules
...
buttons = [
    ...
    [  
        InlineKeyboardButton(text="ᴍᴏʀᴇ", callback_data="AXB_"),
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Alone.modules." + module_name)
...
@Alonecallback(pattern=r"start_back")
@Alonecmd(command="start", pass_args=True)
...
@Alonecallback(pattern=r"stngs_")
...
@Alonemsg(Filters.status_update.migrate)
